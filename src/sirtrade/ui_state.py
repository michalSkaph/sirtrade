...
def _serialize_summary(summary: dict[str, Any]) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "reset_token": summary.get("reset_token"),
        ...
        "live_model_state": summary.get("live_model_state", {}),
...
def _deserialize_summary(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "trade_events_delta": payload.get("trade_events_delta", {}),
        ...
        "live_model_state": payload.get("live_model_state", {}),
